...
<title>Tentang LAPOR! - LAPOR!</title>
...
<meta itemprop="name" content="Tentang LAPOR! - LAPOR!">
...
<meta name="twitter:title" content="Tentang LAPOR! - LAPOR!">
...
<!-- Open Graph data -->
<meta property="og:title" content="Tentang LAPOR! - LAPOR!">
<meta property="og:url" content="https://www.lapor.go.id/tentang">
...
<link rel="canonical" href="https://www.lapor.go.id/tentang">
...
.embed-container embed {
    ...
    height: 100%;
        ...
        <script src="https://www.lapor.go.id/combine/e9a4917f59135d5229709d7de58e1433-1673278447"></script>
	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			...
			<ul class="nav navbar-nav navbar-right ">
				<li class="nav-login">
                    @if(Auth::user())
                    <div class="nav-item dropdown" style="top:20px;">
                        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" style="color: white; font-size: 18px; ">{{Auth::user()->name}}</a>
...
<script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>        
    ...
    <div class="container">
        <div class="block block-aspiration">
            <h1 class="h2"> Profil Kabupaten Pemalang </h1>
            <hr>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="embed-container">
                    <iframe src="https://www.youtube.com/embed/5Z4MnwDlHyg" frameborder="0" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </div>
...
<div class="container pd-t-30">
    <div class="text-content">
        <p class="text-justify">Kabupaten Pemalang memliki luas 1.115,30 Km2. Wilayah Kabupaten Pemalang mencakup 14 Kecamatan, 211 Desa dan 11 Kelurahan.

            Berdasarkan posisi astronomis, kabupaten pemalang terletak pada koordinat109o 17” 30” – 109 o 40” 30” Bujur Timur dan 8o 52” 30”- 7o20”11” Lintang selatan.
            
            Kabupaten Pemalang merupakan salah satu kabupaten di Provinsi Jawa Tengah. dengan batas wilayahnya sebagai berikut :
            ...
            a.        Daerah dataran pantai, yaitu daerah dengan ketinggian antara 1-5 meter di atas permukaan laut. Daerah ini me;iputi 18 desa dan 1 Kelurahan terletak di bagian utara wilayah Pemalang.
            
            b.       Daerah dataran rendah, yaitu daerah dengan ketinggian antara 6-15 meter di atas permukaan laut. Daerah ini meliputi 98 desa dan 5 kelurahan terletak di bagian utara wilayah Kabupaten Pemalang.
            
            c.        Daerah dataran tinngi, yaitu daerah dengan ketinggian antara 16-212 meter di atas permukaan laut. Daerah ini meliputi 35 desa terletak di bagian tengah wilayah Kabupaten Pemalang.
            
            d.       Daerah pegunungan, terbagi 2 yaitu
            
            -          Daerah dengan ketinggian antara 213-924 meter di atas permukaan laut. Daerah ini meliputi 55 desa, terletak di bagian selatan wilayah Kabupaten Pemalang
            
            -          Daerah dengan ketinggian 925 meter di atas permukaan laut, terletak di bagian selatan meliputi 10 desa yang berbatasan dengan kabupaten Purbalingga.</p>
