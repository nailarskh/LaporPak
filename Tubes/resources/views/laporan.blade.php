...
<section id="complaint-box">
    ...
    <form method="POST" action="/laporan_add" accept-charset="UTF-8" data-request="complaint::onCreate" class="complaint-form" data-request-flash=""><input name="_session_key" type="hidden" value="9XKJeyFA3YpJ7blmK8nV0nnOKE6lHNdwEdjiEu1C"><input name="_token" type="hidden" value="Ksh0a1FgSYPqe0VkQ8qU5byYxY2Ue575bYuj6dtE">
        @csrf
        @method("POST")
        <div class="complaint-form-box">
            <div class="select-complaint">Laporpak</div>
            <label for="classification_complaint" class="choose-classification">Isi Lah Form Pengaduan di bawah ini</label>
        ...
        <div class="complaint-help">
            ...
            <a href="#modalPengaduan" data-toggle="modal" class="modalTrigger" id="modalToggler" data-modal-name="modalPengaduan" data-target="#bannerformmodal"><img alt="info-complaint" class="info-complaint" src="https://www.lapor.go.id/themes/lapor/assets/images/info.svg" ></a>
        </div>
        <div class="complaint-form-category">
            <input type="text" name="title" class="form-control" placeholder="Ketik Judul Laporan Anda *" required></textarea>
        </div>
        <div class="complaint-form-category">
            <textarea name="content" id="" rows="6" class="form-control textarea-flex autosize" placeholder="Ketik Isi Laporan Anda *" required></textarea>
        </div>
        <div class="complaint-form-box p-5px" id="date_incident">
            <input type="date" name="tanggal" class="form-control" placeholder="masukkan tanggal kejadian" required>
        </div>
        <div class="complaint-form-category">
            <input type="text" class="form-control" name="location_id" id="location_id" placeholder="Ketik Lokasi Kejadian *" data-request-search="complaint::onSearchLocation" required>
            </input>
        </div>
        ...
        <div class="complaint-form-footer">
            ...
            @if(Auth::user())    
                <input type="submit" href="" class="btn btn-primary" id="submit-complaint" value="LAPOR!"></input>            </div>
            @else
            <center><p style="color: red;"><strong>Masuk ke akun terlebih dahulu untuk dapat mengirim laporan</strong></p></center>
            @endif
            </div>
        </div>
    </form>
